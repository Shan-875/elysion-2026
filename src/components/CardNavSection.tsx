...
import { Info, Mountain, Mic2, Wrench, Images, Mail } from "lucide-react";
...
const navItems: CardNavItem[] = [
  ...
  { href: "#workshops", label: "Workshops", description: "Hands-on sessions", icon: Wrench },
  ...
  return (
    <section className="py-20 md:py-24 bg-[#F8F4ED] border-y border-[#CBA24B]/15">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <CardNav items={navItems} gridClass="grid-cols-2 sm:grid-cols-3 lg:grid-cols-6" />
      </div>
    </section>
  );
}
